...
frank-106@htb[/htb]$ cat /etc/snmp/snmpd.conf | grep -v "#" | sed -r '/^\s*$/d'
...
```
frank-106@htb[/htb]$ snmpwalk -v2c -c public 10.129.14.128
...
```
frank-106@htb[/htb]$ sudo apt install onesixtyone
frank-106@htb[/htb]$ onesixtyone -c /opt/useful/seclists/Discovery/SNMP/snmp.txt 10.129.14.128
...
```
frank-106@htb[/htb]$ sudo apt install braa
frank-106@htb[/htb]$ braa <community string>@<IP>:.1.3.6.*   # Syntax
frank-106@htb[/htb]$ braa public@10.129.14.128:.1.3.6.*
