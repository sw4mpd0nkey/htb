...
```
frank-106@htb[/htb]$ sudo nmap 10.129.14.128 -sV -p110,143,993,995 -sC
...
```
frank-106@htb[/htb]$ curl -k 'imaps://10.129.14.128' --user user:p4ssw0rd
...
```
frank-106@htb[/htb]$ curl -k 'imaps://10.129.14.128' --user cry0l1t3:1234 -v
...
frank-106@htb[/htb]$ openssl s_client -connect 10.129.14.128:pop3s
...
```
frank-106@htb[/htb]$ openssl s_client -connect 10.129.14.128:imaps
...
## Connecting to server for lazt two questions
```
