...
```
frank-106@htb[/htb]$ sudo apt install mysql-server -y
frank-106@htb[/htb]$ cat /etc/mysql/mysql.conf.d/mysqld.cnf | grep -v "#" | sed -r '/^\s*$/d'
...
```
frank-106@htb[/htb]$ sudo nmap 10.129.14.128 -sV -sC -p3306 --script mysql*
...
```
frank-106@htb[/htb]$ mysql -u root -h 10.129.14.132
...
```
frank-106@htb[/htb]$ mysql -u root -pP4SSw0rd -h 10.129.14.128
