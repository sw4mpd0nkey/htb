...
```
frank-106@htb[/htb]$ sudo service postgresql status
...
```
frank-106@htb[/htb]$ sudo systemctl start postgresql
```
...
```
frank-106@htb[/htb]$ sudo msfdb init
...
```
frank-106@htb[/htb]$ sudo msfdb status
...
```
frank-106@htb[/htb]$ sudo msfdb run
...
```
frank-106@htb[/htb]$ msfdb reinit
frank-106@htb[/htb]$ cp /usr/share/metasploit-framework/config/database.yml ~/.msf4/
frank-106@htb[/htb]$ sudo service postgresql restart
...
frank-106@htb[/htb]$ cat Target.nmap
