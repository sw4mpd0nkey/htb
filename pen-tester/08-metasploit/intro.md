...
```
frank-106@htb[/htb]$ ls /usr/share/metasploit-framework/modules
...
```
frank-106@htb[/htb]$ ls /usr/share/metasploit-framework/plugins/
...
```
frank-106@htb[/htb]$ ls /usr/share/metasploit-framework/scripts/
