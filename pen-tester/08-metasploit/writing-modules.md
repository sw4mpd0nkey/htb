...
```
frank-106@htb[/htb]$ searchsploit nagios3
...
```
frank-106@htb[/htb]$ searchsploit -t Nagios3 --exclude=".py"
...
```
frank-106@htb[/htb]$ cp ~/Downloads/9861.rb /usr/share/metasploit-framework/modules/exploits/unix/webapp/nagios3_command_injection.rb
frank-106@htb[/htb]$ msfconsole -m /usr/share/metasploit-framework/modules/
```
...
```
frank-106@htb[/htb]$ ls /usr/share/metasploit-framework/modules/exploits/linux/http/ | grep bludit

bludit_upload_images_exec.rb
```

```
frank-106@htb[/htb]$ cp ~/Downloads/48746.rb /usr/share/metasploit-framework/modules/exploits/linux/http/bludit_auth_bruteforce_mitigation_bypass.rb
```
