...
```shell-session
frank-106@htb[/htb]# nmap -p53 -Pn -sV -sC 10.10.110.213
...
```shell-session
frank-106@htb[/htb]# dig AXFR @ns1.inlanefreight.htb inlanefreight.htb
...
```shell-session
frank-106@htb[/htb]# fierce --domain zonetransfer.me
...
```shell-session
frank-106@htb[/htb]# ./subfinder -d inlanefreight.com -v       
...
```shell-session
frank-106@htb[/htb]$ git clone https://github.com/TheRook/subbrute.git >> /dev/null 2>&1
frank-106@htb[/htb]$ cd subbrute
frank-106@htb[/htb]$ echo "ns1.inlanefreight.com" > ./resolvers.txt
frank-106@htb[/htb]$ ./subbrute inlanefreight.com -s ./names.txt -r ./resolvers.txt
...
```shell-session
frank-106@htb[/htb]# host support.inlanefreight.com
...
```shell-session
frank-106@htb[/htb]# cat /etc/ettercap/etter.dns
