...
```shell-session
frank-106@htb[/htb]$ nmap -Pn -sV -sC -p1433 10.10.10.125
...
```shell-session
frank-106@htb[/htb]$ mysql -u julio -pPassword123 -h 10.129.20.13
...
```shell-session
frank-106@htb[/htb]$ sqsh -S 10.129.203.7 -U julio -P 'MyPassword!' -h
...
```shell-session
frank-106@htb[/htb]$ mssqlclient.py -p 1433 julio@10.129.203.7 
...
```shell-session
frank-106@htb[/htb]$ sudo responder -I tun0
...
```shell-session
frank-106@htb[/htb]$ sudo impacket-smbserver share ./ -smb2support
