...
```shell-session
frank-106@htb[/htb]$ nmap -sT -p22,3306 10.129.202.64
...
```shell-session
frank-106@htb[/htb]$ ssh -L 1234:localhost:3306 ubuntu@10.129.202.64
...
```shell-session
frank-106@htb[/htb]$ netstat -antp | grep 1234
...
```shell-session
frank-106@htb[/htb]$ nmap -v -sV -p1234 localhost
...
```shell-session
frank-106@htb[/htb]$ ssh -L 1234:localhost:3306 -L 8080:localhost:80 ubuntu@10.129.202.64
```
...
```shell-session
frank-106@htb[/htb]$ ssh -D 9050 ubuntu@10.129.202.64
```
...
```shell-session
frank-106@htb[/htb]$ tail -4 /etc/proxychains.conf
...
```shell-session
frank-106@htb[/htb]$ proxychains nmap -v -sn 172.16.5.1-200
...
```shell-session
frank-106@htb[/htb]$ proxychains nmap -v -Pn -sT 172.16.5.19
...
```shell-session
frank-106@htb[/htb]$ proxychains msfconsole
...
```shell-session
frank-106@htb[/htb]$ proxychains xfreerdp /v:172.16.5.19 /u:victor /p:pass@123
...
![RDP Pivot](imgs/proxychaining.webp)
