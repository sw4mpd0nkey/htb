...
![image](imgs/viewdns-results.webp)
...
```shell-session
frank-106@htb[/htb]$ nslookup ns1.inlanefreight.com
...
![image](imgs/ilfreightemails.webp)
...
```shell-session
frank-106@htb[/htb]$ sudo python3 dehashed.py -q inlanefreight.local -p
