...
![Burp B64 Decode](imgs/burp_b64_decode.jpg)
...
![Burp Inspector](imgs/burp_inspector.jpg)

In ZAP, we can use the `Encoder/Decoder/Hash` tool, which will automatically decode strings using various decoders in the `Decode` tab: ![ZAP B64 Decode](imgs/zap_b64_decode.jpg)
...
![Burp B64 Encode](imgs/burp_b64_encode.jpg)

![ZAP B64 Encode](imgs/zap_b64_encode.jpg)
