...
![](/storage/modules/54/web_fnb_main_site.jpg)
...
![](/storage/modules/54/web_fnb_HTB_404.jpg)
...
![](/storage/modules/54/web_fnb_HTB_login.jpg)
...
```shell-session
frank-106@htb[/htb]$ locate directory-list-2.3-small.txt
