...
```shell-session
frank-106@htb[/htb]$ python sqlmap.py -u 'http://inlanefreight.htb/page.php?id=5'
...
```shell-session
frank-106@htb[/htb]$ sudo apt install sqlmap
```
...
```shell-session
frank-106@htb[/htb]$ git clone --depth 1 https://github.com/sqlmapproject/sqlmap.git sqlmap-dev
```
...
```shell-session
frank-106@htb[/htb]$ python sqlmap.py
```
