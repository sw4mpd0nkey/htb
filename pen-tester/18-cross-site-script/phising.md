...
![](/storage/modules/103/xss_phishing_image_viewer.jpg)
...
![](/storage/modules/103/xss_phishing_alert.jpg)
...
![](/storage/modules/103/xss_phishing_injected_login_form.jpg)
...
![](/storage/modules/103/xss_phishing_injected_login_form_2.jpg)
...
![](/storage/modules/103/xss_phishing_injected_login_form_3.jpg)
...
```shell-session
frank-106@htb[/htb]$ sudo nc -lvnp 80
listening on [any] 80 ...
```
...
```shell-session
frank-106@htb[/htb]$ mkdir /tmp/tmpserver
frank-106@htb[/htb]$ cd /tmp/tmpserver
frank-106@htb[/htb]$ vi index.php #at this step we wrote our index.php file
frank-106@htb[/htb]$ sudo php -S 0.0.0.0:80
...
![](/storage/modules/103/xss_image_viewer.jpg)
...
```shell-session
frank-106@htb[/htb]$ cat creds.txt
