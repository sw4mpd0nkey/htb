...
![](/storage/modules/103/xss_blind_test_form.jpg)

As we can see, once we submit the form we get the following message:

![](/storage/modules/103/xss_blind_test_form_output.jpg)
...
```shell-session
frank-106@htb[/htb]$ cat cookies.txt 
...
![](/storage/modules/103/xss_blind_set_cookie_2.jpg)

Once we set our cookie, we can refresh the page and we will get access as the victim:

![](/storage/modules/103/xss_blind_hijacked_session.jpg)
