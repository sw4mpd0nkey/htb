...
```shell-session
frank-106@htb[/htb]$ git clone https://github.com/s0md3v/XSStrike.git
frank-106@htb[/htb]$ cd XSStrike
frank-106@htb[/htb]$ pip install -r requirements.txt
frank-106@htb[/htb]$ python xsstrike.py
...
```shell-session
frank-106@htb[/htb]$ python xsstrike.py -u "http://SERVER_IP:PORT/index.php?task=test" 
