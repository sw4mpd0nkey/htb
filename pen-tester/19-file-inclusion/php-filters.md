...
```shell-session
swmpdnky@htb[/htb]$ ffuf -w /opt/useful/seclists/Discovery/Web-Content/directory-list-2.3-small.txt:FUZZ -u http://<SERVER_IP>:<PORT>/FUZZ.php
...
```shell-session
swmpdnky@htb[/htb]$ echo 'PD9waHAK...SNIP...KICB9Ciov' | base64 -d
