...
![](imgs/file_uploads_content_type_upload.jpg)
...
```shell-session
swmpdnky@htb[/htb]$ wget https://raw.githubusercontent.com/danielmiessler/SecLists/refs/heads/master/Discovery/Web-Content/web-all-content-types.txt
swmpdnky@htb[/htb]$ cat web-all-content-types.txt | grep 'image/' > image-content-types.txt
```
...
![](imgs/file_uploads_bypass_content_type_request.jpg)
...
```shell-session
swmpdnky@htb[/htb]$ echo "this is a text file" > text.jpg 
swmpdnky@htb[/htb]$ file text.jpg 
text.jpg: ASCII text
```
...
```shell-session
swmpdnky@htb[/htb]$ echo "GIF8" > text.jpg 
swmpdnky@htb[/htb]$file text.jpg
