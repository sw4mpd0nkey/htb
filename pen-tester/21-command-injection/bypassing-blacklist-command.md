1. [Page 8](javascript: void\(0\);)
2. Bypassing Blacklisted Commands
...
We have so far successfully bypassed the character filter for the space and semi-colon characters in our payload. So, let us go back to our very first payload and re-add the `whoami` command to see if it gets executed: ![Filter Commands](imgs/cmdinj_filters_commands_1.jpg)
...
![Filter Commands](imgs/cmdinj_filters_commands_2.jpg)
