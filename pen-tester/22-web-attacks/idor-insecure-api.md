...
![](imgs/web_attacks_idor_employee_manager.jpg)
...
![](imgs/web_attacks_idor_edit_profile.jpg)
...
![update_request](imgs/web_attacks_idor_update_request.jpg)
...
![uid_mismatch](imgs/web_attacks_idor_uid_mismatch.jpg)
...
![uuid_mismatch](imgs/web_attacks_idor_uuid_mismatch.jpg)
...
![create_new_user_1](imgs/web_attacks_idor_create_new_user_1.jpg)
...
Finally, let's try to change our `role` to `admin`/`administrator` to gain higher privileges. Unfortunately, without knowing a valid `role` name, we get `Invalid role` in the HTTP response, and our `role` does not update: ![invalid_role](imgs/web_attacks_idor_invalid_role.jpg)
