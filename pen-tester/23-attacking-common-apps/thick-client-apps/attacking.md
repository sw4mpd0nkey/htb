...
![arch_tiers](../imgs/arch_tiers.webp)
...
![change-perms](../imgs/change-perms.webp)
...
![proc-restart](../imgs/proc-restart.webp)

Let's start `x64dbg`, navigate to `Options` -> `Preferences`, and uncheck everything except `Exit Breakpoint`:

![text](https://academy.hackthebox.com/storage/modules/113/Exit_Breakpoint_1.webp)
...
![gdb_banner](https://academy.hackthebox.com/storage/modules/113/Follow-In-Memory-Map.webp)
...
![maps](https://academy.hackthebox.com/storage/modules/113/Identify-Memory-Map.webp)
...
![magic_bytes_3](../imgs/magic_bytes_3.webp)
...
![souce-code_hidden](../imgs/souce-code_hidden.webp)
