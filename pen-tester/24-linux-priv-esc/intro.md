...
```shell-session
frank-106@htb[/htb]$ ls -la /home/stacey.jenkins/
...
```shell-session
frank-106@htb[/htb]$ find / -path /proc -prune -o -type d -perm -o+w 2>/dev/null
...
```shell-session
frank-106@htb[/htb]$ find / -path /proc -prune -o -type f -perm -o+w 2>/dev/null
