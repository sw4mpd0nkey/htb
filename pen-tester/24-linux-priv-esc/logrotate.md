...
```shell-session
frank-106@htb[/htb]$ man logrotate
frank-106@htb[/htb]$ # or
frank-106@htb[/htb]$ logrotate --help
...
```shell-session
frank-106@htb[/htb]$ cat /etc/logrotate.conf
...
```shell-session
frank-106@htb[/htb]$ sudo cat /var/lib/logrotate.status
...
```shell-session
frank-106@htb[/htb]$ ls /etc/logrotate.d/
...
```shell-session
frank-106@htb[/htb]$ cat /etc/logrotate.d/dpkg
...
```shell-session
frank-106@htb[/htb]$ nc -nlvp 9001
