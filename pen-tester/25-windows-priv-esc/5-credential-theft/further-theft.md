...
```shell-session
swmpdnky@htb[/htb]$ python2.7 keepass2john.py ILFREIGHT_Help_Desk.kdbx 
...
```shell-session
swmpdnky@htb[/htb]$ hashcat -m 13400 keepass_hash /opt/useful/seclists/Passwords/Leaked-Databases/rockyou.txt
