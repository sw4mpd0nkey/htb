...
![Image](../imgs/C_users_restricted.webp)
...
2. Select `Properties`. ![Image](../imgs/shortcut_1.webp)
    
3. Within the `Target` field, modify the path to the intended folder for access. ![Image](../imgs/shortcut_2.webp)
    
4. Execute the Shortcut and cmd will be spawned ![Image](../imgs/shortcut_3.webp)
...
3. Input the command "cmd" into the file. ![Image](../imgs/script_bat.webp)
4. Save the file.
